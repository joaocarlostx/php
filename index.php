<?php 
require_once("conexao.php"); //conectar com o arquivo de conexão 
...
$total_reg = @count($res);
if($total_reg == 0){
  $pdo->query("INSERT into usuarios SET empresa = '0', nome = 'Administrador SAS', cpf = '000.000.000-00', email = 'contato@roisolucoes.com', senha = '$senha', senha_crip = '$senha_crip', ativo = 'Sim', foto = 'sem-foto.jpg', nivel = 'Administrador', data = curDate() ");
}
        ...
        <center>
          <div class="middle">
            <div id="login">
              <div class="wrapper">
                <div class="logo">
                 <img src="img/logo.png" widht="">
               </div>
               <div class="text-center mt-4 name">
               </div>
               <form class="p-3 mt-3" action="autenticar.php" method="post">
                <div class="form-field d-flex align-items-center" style="background-color:transparent;">
                  <small><span class="fa fa-user"></span></small>
                  <small><input type="text" name="usuario" id="usuario-login" placeholder="Usuário"></small>
                </div>
                ...
                <div  >
                   <span style="width:48%; text-align:left;  display: inline-block;"><b><a class="" href="" data-toggle="modal" data-target="#exampleModal">Recuperar Senha </a></b> <b> <a style="display:<?php echo $mostrar_teste ?>; color:#36DB00" href="" data-toggle="modal" data-target="#modalCadastro">Testar Sistema </a></span></b>
                  <span style="width:50%; text-align:right;  display: inline-block; "><input class="btn mt-3" type="submit" value="Entrar" style='margin-top: -10px'></span>
                  </div>
                </form>
              ...
              <b><p align="center">© 2022 ROI SOLUÇÕES DIGITAIS</p></b>
              <!-- Modal -->
              <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content" style="width:350px;border-radius:30px">
                   <button id="btn-fechar-rec" type="submit" class="close" data-dismiss="modal" aria-label="Close" style="position:absolute; right:10px; top:10px">
                  ...
                  <form method="post" id="form-recuperar">
                    <div class="modal-body"  style="width:300px">
                      ...
                      <br>
                      <button class="btn mt-3" type="submit" style="width:100%" type="submit" class="btn btn-primary">Enviar Senha</button>  
                      <br>
        ...
        <div class="modal-dialog" role="document" >
          ...
          <form method="post" id="form-cad">
            <div class="modal-body" >
              ...
              <div class="row" style="margin-top: 15px">
                ...
                <div class="col-md-12">
                  ...
                  <select class="form-control" name="modalidade" id="Modalidade" onchange="mudarModalidade()">
            ...
            <div class="modal-footer">       
              <button  style="background: #36DB00" type="submit" class="btn btn-primary">Cadastrar</button>
            </div>
          </form>
        </div>
      </div>
...
<script type="text/javascript">
  function mudarModalidade(){
    ...
    if(modalidade.trim() == 'atacado'){
      $('#label-modalidade').text('atacado');
      
    }elseif{
      $('#label-modalidade').text('varejo');
      
    }else{
      $('#label-modalidade').text('treinamentos');
    }
